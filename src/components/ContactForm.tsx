            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input placeholder="Amit Singh" className="bg-white/5 border-white/10 rounded-xl h-12" required />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">Email</label>
                  <Input type="email" placeholder="amit@example.com" className="bg-white/5 border-white/10 rounded-xl h-12" required />
                </div>
              </div>
              <div className="space-y-2">
